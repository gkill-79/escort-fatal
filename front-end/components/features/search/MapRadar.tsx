  ...
  return L.divIcon({
    ...
    html: `
      <div style="
        ...
        position: relative; 
        border-radius: 50%; 
        border: 2.5px solid ${profile.isTopGirl ? '#FBBF24' : '#E63946'};
      ...
      <div style="
        ...
        border-top: 8px solid ${profile.isTopGirl ? '#FBBF24' : '#E63946'};
      "></div>
    `,
    iconSize: [44, 52],
              ...
              >
                <div className="p-1 -m-1">
                   ...
                   <div className="flex justify-between items-start mb-1">
                     <h3 className="font-bold text-dark-950 text-base leading-tight truncate pr-2">
                       {profile.name} <span className="font-normal text-dark-500 text-sm">{profile.age} ans</span>
                     </h3>
                     {profile.isOnline && (
                       <span className="shrink-0 flex items-center justify-center w-5 h-5 bg-green-100 rounded-full">
                         <span className="w-2.5 h-2.5 bg-green-500 rounded-full animate-pulse"></span>
                       </span>
                     )}
                   </div>

                   <p className="text-xs text-dark-600 flex items-center gap-1 mb-2">
